...
class datasets_sparse(torch.utils.data.Dataset):
    """
    ...
    def __getitem__(self, index):
        ...
        for i_try in range(self._num_retries):
            ...
            '''
            frames_r, frames_g, frames_b = decoder.decode(
                video_container,
                sampling_rate,
                self.cfg.DATA.NUM_FRAMES,
                temporal_sample_index,
            ...
            r = frames_r[:,:,:,0] # torch.Size([32, 240, 320, 1])
            g = frames_g[:,:,:,1]
            b = frames_b[:,:,:,2]
            frames = torch.stack([r,g,b], dim = -1)    
